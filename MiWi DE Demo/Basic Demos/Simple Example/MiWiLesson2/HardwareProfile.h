...
//        #define RUN_AT_80MHZ
        ...
        #define LED_5               LATAbits.LATA3
        #define LED_6               LATAbits.LATA2
        #define LED_7               LATAbits.LATA1
        #define LED_8               LATAbits.LATA0

        #define LED3_OFF()          {LATACLR = BIT_5;}
        #define LED3_ON()           {LATASET = BIT_5;}
    ...
    #elif defined(__PIC32MX__) && defined(EXPLORER16)
