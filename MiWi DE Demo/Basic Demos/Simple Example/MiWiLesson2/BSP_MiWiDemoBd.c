...
{
#if defined(MIWI_CARD_DEMO_BOARD) || defined(EXPLORER16) || defined(PIC32_WIRELESS_EVAL_BOARD) || defined(PIC18_EXPLORER) || (defined(EIGHT_BIT_WIRELESS_BOARD) && defined(SENSOR_PORT_LCD))
        LCDErase();
        #if defined(MIWI_CARD_DEMO_BOARD) || defined(PIC18_EXPLORER) || defined(EIGHT_BIT_WIRELESS_BOARD)
