...
${OBJECTDIR}/_ext/1198648459/BSP_PC32MX_WirelessEvalBoard.o: ../bsp_wireless_eval_board/BSP_PC32MX_WirelessEvalBoard.c  nbproject/Makefile-${CND_CONF}.mk 
	...
	@${FIXDEPS} "${OBJECTDIR}/_ext/1198648459/BSP_PC32MX_WirelessEvalBoard.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c ${MP_CC} $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_REAL_ICE=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -mappio-debug -DWIRELESS_EVAL_BOARD -D_SUPPRESS_PLIB_WARNING -I"../../../../../Microchip/Include" -I"../../../../../MiWi DE Demo/Basic Demos/Feature Demo/Node 2" -MMD -MF "${OBJECTDIR}/_ext/1198648459/BSP_PC32MX_WirelessEvalBoard.o.d" -o ${OBJECTDIR}/_ext/1198648459/BSP_PC32MX_WirelessEvalBoard.o ../bsp_wireless_eval_board/BSP_PC32MX_WirelessEvalBoard.c  
...
${OBJECTDIR}/_ext/1198648459/BSP_PC32MX_WirelessEvalBoard.o: ../bsp_wireless_eval_board/BSP_PC32MX_WirelessEvalBoard.c  nbproject/Makefile-${CND_CONF}.mk 
	...
	@${RM} ${OBJECTDIR}/_ext/1198648459/BSP_PC32MX_WirelessEvalBoard.o.d 
	@${RM} ${OBJECTDIR}/_ext/1198648459/BSP_PC32MX_WirelessEvalBoard.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1198648459/BSP_PC32MX_WirelessEvalBoard.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c ${MP_CC} $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -mappio-debug -DWIRELESS_EVAL_BOARD -D_SUPPRESS_PLIB_WARNING -I"../../../../../Microchip/Include" -I"../../../../../MiWi DE Demo/Basic Demos/Feature Demo/Node 2" -MMD -MF "${OBJECTDIR}/_ext/1198648459/BSP_PC32MX_WirelessEvalBoard.o.d" -o ${OBJECTDIR}/_ext/1198648459/BSP_PC32MX_WirelessEvalBoard.o ../bsp_wireless_eval_board/BSP_PC32MX_WirelessEvalBoard.c  
...
dist/${CND_CONF}/${IMAGE_TYPE}/MPLAB.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/MPLAB.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}       -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=_min_heap_size=2048,--defsym=_min_stack_size=2048,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"
