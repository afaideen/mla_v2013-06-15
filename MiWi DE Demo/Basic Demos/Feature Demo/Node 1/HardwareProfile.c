...
//        LED_2_TRIS = 0;
//        LED_7_TRIS = 0;
        TRISA = 0; //PORTA all pins are output
        PORTA = 0;
        ...
        SPI_SCK = 0;             
           ...
           /* Set the Interrupt Priority */
           mINT1SetIntPriority(4);//original (w/o Tick.c)
//           mINT2SetIntPriority(4);//if Tick.c is used
           #if defined(MRF89XA)
               mINT2SetIntPriority(4);            
           #endif
...
{
    #if defined(PIC32_WIRELESS_EVAL_BOARD) || defined(EXPLORER16) || defined(PIC18_EXPLORER) || (defined(EIGHT_BIT_WIRELESS_BOARD) && defined(SENSOR_PORT_LCD))
        LCDErase();
