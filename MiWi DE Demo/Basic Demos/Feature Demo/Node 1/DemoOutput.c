...
void DemoOutput_Greeting(void)
{
        ...
        Printf("\r\n              LED 2: RA3");
    #endif
    #if defined(EXPLORER16) || defined(PIC32_WIRELESS_EVAL_BOARD) 
        Printf("\r\nInput Configuration:");
...
void DemoOutput_ActiveScanResults(BYTE num)
{
    BYTE j;
...
void DemoOutput_Instruction(void)
{
        ...
        LCDDisplay((char *)"SW1: Freq Hop   SW2: Unicast", 0, FALSE);
    #elif defined(WIRELESS_EVAL_BOARD) || defined(PIC32_WIRELESS_EVAL_BOARD)
        LCDDisplay((char *)"SW0: Freq Hop   SW2: Unicast", 0, FALSE);
    #endif
}  
...
void DemoOutput_InitFreqHop(void)
{
    LCDDisplay((char *)" Init Freq Hop", 0, FALSE);
}    

void DemoOutput_FreqHopSuccess(void)
{
...
void DemoOutput_FreqHopFail(void)
{
