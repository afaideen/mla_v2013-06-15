...
{   
    ...
    /*******************************************************************/
    BoardInit();
//#ifndef PIC32_WIRELESS_EVAL_BOARD
...
//        DemoOutput_StartActiveScan();
        ...
        //     preferred.
        /*******************************************************************/
//        i = MiApp_SearchConnection(10, 0xFFFFFFFF);//original
////        WORD scan_chnl = 1 << 11;
////        i = MiApp_SearchConnection(10, scan_chnl);
...
//    MIWI_TICK t3 = MiWi_TickGet();
//    MIWI_TICK t2 = MiWi_TickGet();
...
//        if( MiWi_TickGetDiff(t2, t3) > 2 * ONE_SECOND )
        {
            t1 = TickGet();
//            t2 = MiWi_TickGet();
            LED_0 ^= 1;
        ...
        else
        {
            ...
            switch( PressedButton )
            {
                ...
                case 2:
                    ...
                    for(i = 0; i < 11; i++)
                    {
                        data_val2 = TxSynCount%6;
                        data_val = DE[data_val2][i];
                        MiApp_WriteData(data_val);
                    }
                    TxSynCount++;
