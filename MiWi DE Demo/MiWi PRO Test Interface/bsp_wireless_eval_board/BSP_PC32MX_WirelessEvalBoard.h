...
#define SW0_PORT            BUTTON0_IO 
#define SW0_TRIS            BUTTON0_TRIS
#define SW1_PORT            BUTTON1_IO 
...
#define MAC_nCS             EEPROM_CS_IO
// EEProm Pin Definitions
#define RF_EEnCS		    EEPROM_CS_IO
#define RF_EEnCS_TRIS	    EEPROM_CS_TRIS
