...
*  4.0   08/09/2010   yfy       Initial release
*  4.1b  03/10/2011   yfy       MiWi DE 4.1 Beta
...
#include "ConfigApp.h"
    ...
    BYTE            TxData;    
        ...
        #pragma udata TRX_BUFFER
            ...
            BYTE TxBuffer[112];
        #else
            BYTE TxBuffer[TX_BUFFER_SIZE+MIWI_PRO_HEADER_LEN];
        #endif
    ...
    union _MIWI_PRO_NVM_STATUS
    {
        ...
        struct
        {
            BYTE    saveFamilyTree          :1;
            BYTE    saveRoutingTable        :1;
            BYTE    saveNeighborTable       :1;
            BYTE    saveConnectionTable     :1;
        } bits;        
    } MiWiPRONVMStatus;
    ...
    BOOL MultiCast( INPUT BYTE MultiCastMode, INPUT BOOL SecEn );
