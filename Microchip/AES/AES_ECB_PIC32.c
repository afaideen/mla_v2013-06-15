...
UINT8 InvSbox[256] = {	// inverse s-box
...
#define V(a,b,c,d) 0x##a##b##c##d
static const UINT32 U0[256] = { UT };
#undef V

#define V(a,b,c,d) 0x##d##a##b##c
static const UINT32 U1[256] = { UT };
#undef V

#define V(a,b,c,d) 0x##c##d##a##b
static const UINT32 U2[256] = { UT };
#undef V

#define V(a,b,c,d) 0x##b##c##d##a
static const UINT32 U3[256] = { UT };
#undef V
#undef UT

static const UINT8 Rcon[30] =
{
...
void AESECBEncryptBlock(UINT8 *plain_text, void *session, UINT8 *cipher_text, AES_KEY_TYPE key_type)
{
	...
	tt = session_key->key[0][Nr][0];
	cipher_text[0] = Sbox[(UINT8)(t0 >> 24)] ^ (UINT8)(tt >> 24);
	cipher_text[1] = Sbox[(UINT8)(t1 >> 16)] ^ (UINT8)(tt >> 16);
	cipher_text[2] = Sbox[(UINT8)(t2 >>  8)] ^ (UINT8)(tt >>  8);
	cipher_text[3] = Sbox[(UINT8)t3] ^ (UINT8)tt;

	tt = session_key->key[0][Nr][1];
	cipher_text[4] = Sbox[(UINT8)(t1 >> 24)] ^ (UINT8)(tt >> 24);
	cipher_text[5] = Sbox[(UINT8)(t2 >> 16)] ^ (UINT8)(tt >> 16);
	cipher_text[6] = Sbox[(UINT8)(t3 >>  8)] ^ (UINT8)(tt >>  8);
	cipher_text[7] = Sbox[(UINT8)t0] ^ (UINT8)tt;

	tt = session_key->key[0][Nr][2];
	cipher_text[8] = Sbox[(UINT8)(t2 >> 24)] ^ (UINT8)(tt >> 24);
	cipher_text[9] = Sbox[(UINT8)(t3 >> 16)] ^ (UINT8)(tt >> 16);
	cipher_text[10] = Sbox[(UINT8)(t0 >>  8)] ^ (UINT8)(tt >>  8);
	cipher_text[11] = Sbox[(UINT8)t1] ^ (UINT8)tt;

	tt = session_key->key[0][Nr][3];
	cipher_text[12] = Sbox[(UINT8)(t3 >> 24)] ^ (UINT8)(tt >> 24);
	cipher_text[13] = Sbox[(UINT8)(t0 >> 16)] ^ (UINT8)(tt >> 16);
	cipher_text[14] = Sbox[(UINT8)(t1 >>  8)] ^ (UINT8)(tt >>  8);
	cipher_text[15] = Sbox[(UINT8)t2] ^ (UINT8)tt;
}
...
void AESECBDecryptBlock(UINT8 *cipher_text, void *session, UINT8 *plain_text, AES_KEY_TYPE key_type)
{
	...
	//Last Round is special
	tt = session_key->key[1][Nr][0];
	plain_text[ 0] = InvSbox[(UINT8)(t0 >> 24)] ^ (UINT8)(tt >> 24);
	plain_text[ 1] = InvSbox[(UINT8)(t3 >> 16)] ^ (UINT8)(tt >> 16);
	plain_text[ 2] = InvSbox[(UINT8)(t2 >>  8)] ^ (UINT8)(tt >>  8);
	plain_text[ 3] = InvSbox[(UINT8) t1] ^ (UINT8)tt;

	tt = session_key->key[1][Nr][1];
	plain_text[ 4] = InvSbox[(UINT8)(t1 >> 24)] ^ (UINT8)(tt >> 24);
	plain_text[ 5] = InvSbox[(UINT8)(t0 >> 16)] ^ (UINT8)(tt >> 16);
	plain_text[ 6] = InvSbox[(UINT8)(t3 >>  8)] ^ (UINT8)(tt >>  8);
	plain_text[ 7] = InvSbox[(UINT8) t2] ^ (UINT8)tt;

	tt = session_key->key[1][Nr][2];
	plain_text[ 8] = InvSbox[(UINT8)(t2 >> 24)] ^ (UINT8)(tt >> 24);
	plain_text[ 9] = InvSbox[(UINT8)(t1 >> 16)] ^ (UINT8)(tt >> 16);
	plain_text[10] = InvSbox[(UINT8)(t0 >>  8)] ^ (UINT8)(tt >>  8);
	plain_text[11] = InvSbox[(UINT8) t3] ^ (UINT8)tt;

	tt = session_key->key[1][Nr][3];
	plain_text[12] = InvSbox[(UINT8)(t3 >> 24)] ^ (UINT8)(tt >> 24);
	plain_text[13] = InvSbox[(UINT8)(t2 >> 16)] ^ (UINT8)(tt >> 16);
	plain_text[14] = InvSbox[(UINT8)(t1 >>  8)] ^ (UINT8)(tt >>  8);
	plain_text[15] = InvSbox[(UINT8) t0] ^ (UINT8)tt;
}
