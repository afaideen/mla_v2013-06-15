...
typedef enum
{
    ...
    AES_KEY_TYPE_128_BIT,       // Use an AES key length of 128-bits.
    AES_KEY_TYPE_192_BIT,       // Use an AES key length of 192-bits.
    AES_KEY_TYPE_256_BIT        // Use an AES key length of 256-bits.
#else
...
#ifdef _AES_KEY_192
    AES_KEY_TYPE_192_BIT,       // Use an AES key length of 128-bits.
#endif

#ifdef _AES_KEY_256
    AES_KEY_TYPE_256_BIT,       // Use an AES key length of 128-bits.
#endif
