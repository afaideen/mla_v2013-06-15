...
${OBJECTDIR}/Helper/MyHelper.o: Helper/MyHelper.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/Helper/MyHelper.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c ${MP_CC} $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_REAL_ICE=1   -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -DPROTOCOL_MIWI_PRO -DCFG_INCLUDE_PIC32_EVAL_BOARD -D_SUPPRESS_PLIB_WARNING -I".." -I"../../../Microchip/Include" -I"../../../../Microchip/Include" -I"../../../../Microchip/Include/TCPIP Stack" -I"../Configs" -I"../LocalFiles" -I"../../../../TCPIP/WiFi EZConfig" -Wall -MMD -MF "${OBJECTDIR}/Helper/MyHelper.o.d" -o ${OBJECTDIR}/Helper/MyHelper.o Helper/MyHelper.c  
...
${OBJECTDIR}/Helper/MyHelper.o: Helper/MyHelper.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/Helper/MyHelper.o.d 
	@${RM} ${OBJECTDIR}/Helper/MyHelper.o 
	@${FIXDEPS} "${OBJECTDIR}/Helper/MyHelper.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c ${MP_CC} $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -DPROTOCOL_MIWI_PRO -DCFG_INCLUDE_PIC32_EVAL_BOARD -D_SUPPRESS_PLIB_WARNING -I".." -I"../../../Microchip/Include" -I"../../../../Microchip/Include" -I"../../../../Microchip/Include/TCPIP Stack" -I"../Configs" -I"../LocalFiles" -I"../../../../TCPIP/WiFi EZConfig" -Wall -MMD -MF "${OBJECTDIR}/Helper/MyHelper.o.d" -o ${OBJECTDIR}/Helper/MyHelper.o Helper/MyHelper.c  
