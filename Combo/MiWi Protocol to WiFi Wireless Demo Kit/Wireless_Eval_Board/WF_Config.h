...
#ifdef MRF24WG
    #define MY_DEFAULT_NETWORK_TYPE             CFG_WF_SOFT_AP   /*  WF_ADHOC, WF_SOFT_AP  */
#else
    #define MY_DEFAULT_NETWORK_TYPE             CFG_WF_ADHOC//CFG_WF_INFRASTRUCTURE   
#endif
...
#define MY_DEFAULT_BSSID					{0xff,0xff,0xff,0xff,0xff,0xff}
#define MY_DEFAULT_WIFI_SECURITY_KEY	{0}
#define MY_DEFAULT_WIFI_SECURITY_KEY_LEN 0
#define WF_USE_HIDDEN_SSID                  0       /* 1 - enable hidden ssid in adhoc mode */

#define MY_WEP_KEY_TYPE                     0       /* 0- shared key, 1 - open key */
#define MY_DEFAULT_ADHOC_BEHAVIOR           WF_ADHOC_CONNECT_THEN_START
#define MY_DEFAULT_CHANNEL_LIST_SIZE        3	// WARNING. Make sure this is the number of desired channels
//*************END
 ...
 *
 * SoftAP's default IP is 169.254.1.1 and its Network Mask is 255.255.0.0. Users can set this to 192.168.1.3 if this network addressing scheme is preferable
...
//        #define MY_DEFAULT_WIFI_SECURITY_MODE       WF_SECURITY_WPA2_WITH_PASS_PHRASE        /* Open & WEP security supported.     
        ...
        #define MY_DEFAULT_SSID_NAME                "MCHP_G_xxxx"            /* Set SoftAP ssid                  */
        #define MY_DEFAULT_LIST_RETRY_COUNT         ADHOC_RETRY_COUNT       /* Dummy, Not used                  */
        #define MY_DEFAULT_CHANNEL_LIST             {1, 6, 11}                     /* Set SoftAP network channel       */
        #define MY_DEFAULT_CHANNEL_LIST_PRESCAN     {1, 6, 11}              /* SoftAP: Pre-scan channel list WF_PRESCAN */
        #define MY_DEFAULT_CHANNEL_LIST_POSTSCAN    {1, 6, 11}                      /* SoftAP: Post-scan channel list */
