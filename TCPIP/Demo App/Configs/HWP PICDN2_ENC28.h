...
// Hardware I/O pin mappings
#if defined(__18F6723_H)
    // LEDs
    #define LED0_TRIS			1//(TRISJbits.TRISJ0)	// Ref D8
    #define LED0_IO				1//(LATJbits.LATJ0)
    #define LED1_TRIS			1//(TRISJbits.TRISJ1)	// Ref D7
    ...
    #define LED6_TRIS			1//(TRISJbits.TRISJ6)	// Ref D2
    #define LED6_IO				1//(LATJbits.LATJ6)
