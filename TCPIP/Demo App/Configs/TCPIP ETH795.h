...
#define MY_DEFAULT_IP_ADDR_BYTE3        (100ul)//(1ul)
#define MY_DEFAULT_IP_ADDR_BYTE4        (10ul)//(1ul)
...
#define MY_DEFAULT_GATE_BYTE3           (100ul)//(1ul)
...
#define MY_DEFAULT_PRIMARY_DNS_BYTE3	(100ul)//(1ul)
